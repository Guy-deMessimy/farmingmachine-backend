...
Mettre a jour Prisma Client après chaque changement dans le modèle Prisma : 

```sh
prisma generate
```

lancer ensuite le serveur avec `npm run start:dev` qui sera sur [localhost:3000](http://localhost:3000/)
